...
## Firmware 1.0.0 — song ngữ, quản lý trang và Device API
...
- Layout 4 MB dùng hai app OTA `0x140000` và LittleFS `0x160000` tại `0x290000`. Phải nạp full qua USB một lần khi chuyển từ bản cũ.
